...
variable5 = g() # Data type of variable5: function that outputs a Boolean

variable6 = [1,2,3] #list

variable7 = (1,3,5) #tuple

variable8 = {"brand": "Ford", "model": "Mustang", "year": 1964} #dictionary
...
#in integer division, the result returns the decimal value of the two numbers divided
#floor division returns the lower integer (rounds down)
